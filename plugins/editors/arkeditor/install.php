...
class plgEditorsArkeditorInstallerScript
{
	...
	function postflight($type, $parent)
	{
		...
		if($type == 'install')
		{
			...
			$toolbars = base64_encode('{"full":[["Maximize","Scayt","SpellChecker","Print"],["Cut","Copy","SelectAll","Paste","PasteText","PasteFromWord"],["Bold","Italic","Underline","Strike","Superscript","Subscript","SpecialChar","Blockquote"],["NumberedList","BulletedList","Outdent","Indent"],["BidiRtl","BidiLtr"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["Unlink","Link","Email","Anchor"],["Document","Image","Arkmediabutton"],["Styles","Format","Font"],["FontSize","RemoveFormat"],["TextColor","BGColor"],["Table","HorizontalRule","CreateDiv","Iframe","Flash","Smiley","About"],["Fontawesome"]],"back":[["Maximize","Scayt"],["Cut","Copy","SelectAll","Paste","PasteFromWord"],["Bold","Italic","Underline","Strike","Superscript","SpecialChar","Blockquote"],["NumberedList","BulletedList","Outdent","Indent"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["Unlink","Link","Email","Anchor"],["Document","Image","Arkmediabutton"],["Format","Styles","RemoveFormat"],["Table","HorizontalRule","CreateDiv","Iframe"],["Fontawesome"]],"front":[["Maximize","Source","ShowBlocks","Scayt"],["Undo","Redo","Versions"],["Cut","PasteFromWord"],["Bold","Italic","Underline","Blockquote"],["NumberedList","BulletedList"],["JustifyLeft","JustifyCenter","JustifyRight","JustifyBlock"],["Unlink","Link","Email","Anchor"],["Document","Image","Arkmediabutton"],["Format","Styles","RemoveFormat"],["Table","CreateDiv","Smiley"],["Fontawesome"]],"inline":[["Sourcedialog","PasteText"],["Bold","NumberedList","BulletedList"],["Format"],["CreateDiv"],["Link","Readmore"],["Undo","Redo","Versions"],["Image","Arkmediabutton"],["Arkwidgetbutton"],["Close"]],"title":[["Save"],["Cut","Copy","PasteText"],["Undo","Redo"],["Close"]],"image":[["Save"],["Image"],["Link","Document"],["Versions"],["Close"]],"mobile":[["Bold"],["Link"],["Image"],["Save"],["Versions"],["Close"]]}');
