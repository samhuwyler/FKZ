...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	?>
		<div id="jsn-header">
			<div id="jsn-header-inner" class="clearafter">
				<?php
					...
					if ($jsnutils->countModules('push') > 0) {
				?>
					<div id="jsn-push">
						<jdoc:include type="modules" name="push" style="jsnmodule" />
					</div>
		...
		?>
			...
			<div id="jsn-content-top-below">
				<div id="jsn-pos-content-top-below" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $jsnutils->countModules('content-top'); ?> row-fluid">
					<jdoc:include type="modules" name="content-top-below" style="jsnmodule" columnClass="span<?php echo ceil(12 / $jsnutils->countModules('content-top-below')); ?>" />
				</div>
			</div>
			<?php
				}
	...
	?>
	<div id="jsn-brand">
		JSN Mini template designed by <a href="http://www.joomlashine.com" target="_blank" title="Free Hi-Quality Joomla Templates on JoomlaShine">JoomlaShine.com</a>
	</div>
	</div>
